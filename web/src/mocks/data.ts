...
const gtaCoreContacts: Contact[] = [
    ...
    },
    {
        ...
        lastname: "Yetarian",
        phone: "555-0144",
        avatar: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=500&auto=format&fit=crop&q=80",
        favorite: false,
        ...ts(),
    },
    {
    ...
    },
    {
        ...
        lastname: "Clinton",
        phone: "555-0177",
        avatar: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=500&auto=format&fit=crop&q=80",
        favorite: true,
        ...ts(),
    },
    {
...
const firstNames = [
    "Aaron", "Abigail", "Adam", "Adrian", "Alan", "Alex", "Alexander", "Alexis", "Alice", "Alicia",
    "Amanda", "Amber", "Amy", "Andrew", "Angela", "Ann", "Anna", "Anthony", "Arthur", "Ashley",
    "Austin", "Barbara", "Benjamin", "Bob", "Brandon", "Brian", "Brittany", "Bruce", "Bryan", "Caleb",
    "Cameron", "Carl", "Carlos", "Caroline", "Catherine", "Charles", "Charlotte", "Christian", "Christina", "Christopher",
    "Cody", "Connor", "Daniel", "David", "Dennis", "Diana", "Donald", "Donna", "Douglas", "Dylan",
    "Edward", "Elizabeth", "Emily", "Eric", "Ethan", "Eugene", "Evelyn", "Frank", "Gabriel", "George",
    "Gerald", "Gregory", "Hannah", "Harold", "Harry", "Heather", "Helen", "Henry", "Holly", "Ian",
    "Isaac", "Jack", "Jacob", "James", "Jason", "Jeffrey", "Jennifer", "Jerry", "Jesse", "Jessica"
];

const lastNames = [
    "Adams", "Alexander", "Allen", "Anderson", "Armstrong", "Arnold", "Bailey", "Baker", "Barnes", "Bell",
    "Bennett", "Berry", "Bishop", "Black", "Bradley", "Brooks", "Brown", "Bryant", "Burke", "Burns",
    "Butler", "Campbell", "Carlson", "Castillo", "Castro", "Chapman", "Chavez", "Clark", "Coleman", "Collins",
    "Cook", "Cooper", "Cox", "Cruz", "Cunningham", "Daniels", "Davis", "Delgado", "Diaz", "Dixon",
    "Drake", "Duncan", "Dunn", "Edwards", "Elliott", "Ellis", "Evans", "Ferguson", "Fernandez", "Flores",
    "Foster", "Fowler", "Fox", "Franklin", "Garcia", "Gardner", "Gibson", "Gomez", "Gonzalez", "Gordon",
    "Graham", "Grant", "Gray", "Green", "Griffin", "Hall", "Hamilton", "Hansen", "Harper", "Harris"
];
...
const conversationTitles: { is_group: boolean; name: string; phone: string; cit: string; avatar?: string }[] = [
    { is_group: false, name: "Ursula (Crazy Ex)", phone: "555-0199", cit: "gta-ursula", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=500&auto=format&fit=crop&q=80" },
    { is_group: true, name: "Union Depository Heist", phone: "group", cit: "group-heist", avatar: getUniqueAvatar("heist-crew", 1) },
    { is_group: false, name: "Trevor Philips", phone: "555-0133", cit: "gta-trevor", avatar: undefined },
    { is_group: true, name: "LSPD Central Dispatch", phone: "group", cit: "group-lspd", avatar: "https://images.unsplash.com/photo-1617814076367-b759c7d7e738?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Simeon Yetarian", phone: "555-0144", cit: "gta-simeon", avatar: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=500&auto=format&fit=crop&q=80" },
    { is_group: true, name: "Los Santos Tuners Club", phone: "group", cit: "group-tuners", avatar: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Lester Crest", phone: "555-0155", cit: "gta-lester", avatar: undefined },
    { is_group: false, name: "Michael De Santa", phone: "555-0166", cit: "gta-michael", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=500&auto=format&fit=crop&q=80" },
    { is_group: true, name: "Dynasty 8 Executive VIPs", phone: "group", cit: "group-realestate", avatar: getUniqueAvatar("dynasty-8", 2) },
    { is_group: false, name: "Franklin Clinton", phone: "555-0177", cit: "gta-franklin", avatar: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Lamar Davis", phone: "555-0188", cit: "gta-lamar", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=80" },
    { is_group: true, name: "Diamond Casino VIPs", phone: "group", cit: "group-casino", avatar: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Pavel (Kosatka)", phone: "555-0111", cit: "gta-pavel", avatar: undefined },
    { is_group: true, name: "Benny's Motorworks", phone: "group", cit: "group-bennys", avatar: "https://images.unsplash.com/photo-1517849845537-4d257902454a?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Agent 14", phone: "555-0122", cit: "gta-agent14", avatar: undefined },
    { is_group: true, name: "Pillbox Hill EMS", phone: "group", cit: "group-ems", avatar: getUniqueAvatar("pillbox-ems", 4) },
    { is_group: false, name: "Tracey De Santa", phone: "555-0134", cit: "gta-tracey", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Ron Jakowski", phone: "555-0145", cit: "gta-ron", avatar: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=500&auto=format&fit=crop&q=80" },
    { is_group: true, name: "Vanilla Unicorn VIP", phone: "group", cit: "group-unicorn", avatar: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=500&auto=format&fit=crop&q=80" },
    { is_group: false, name: "Solomon Richards", phone: "555-0156", cit: "gta-solomon", avatar: undefined },
];
...
export const mockConversations: Conversation[] = conversationTitles.map((c, convIndex) => {
    ...
    const isSentByMeRead = !isCrazyEx && (convId === 2 || convId === 5 || (convId > 7 && convId % 3 === 0));
    const isSentByMeDelivered = !isCrazyEx && (convId === 3 || convId === 6 || (convId > 7 && convId % 3 === 1));
    ...
    if (isCrazyEx) {
        ...
        recipientLastRead = (msgList[198]?.created_at || new Date(Date.now() - 3600000).toISOString()) as string;
    } else if (isOtherUnread) {
